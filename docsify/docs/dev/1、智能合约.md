...
export method:
	...
	upgrade				升级						    参数：无
	save                存证保存					    参数：file_name, file_hash, time
	find_by_file_hash   存证查询，根据file_hash查询      参数：file_hash
*/
...
pub extern "C" fn save() {
    ...
    // 存储
    ctx.put_state("fact", &file_hash, ec.marshal().as_slice());
}
