...
目前推荐使用**Remix**编译器来进行Solidity合约的开发与编译。

[Remix](https://remix.ethereum.org/)可在线使用，无需要安装任何东西。如果需要处理大型合约，或者需要更多的编译选项，可以使用命令行编译器**solc**，可以在[solidity/releases](https://github.com/ethereum/solidity/releases)下载Solidity二进制安装包。
...
请参考：[《chainmaker-go-sdk》](https://git.code.tencent.com/ChainMaker/docs/docsify/docs/dev/docs/dev/chainmaker-go-sdk.md)发送创建合约请求的部分，或者[《chainmaker-java-sdk》](https://git.code.tencent.com/ChainMaker/docs/docs/dev/chainmaker-java-sdk.md)创建合约的部分。

## 4.3合约调用过程

请参考：[《chainmaker-go-sdk》](https://git.code.tencent.com/ChainMaker/docs/docs/dev/chainmaker-go-sdk.md)合约调用的部分，或者[《chainmaker-java-sdk》](https://git.code.tencent.com/ChainMaker/docs/docs/dev/chainmaker-java-sdk.md)执行合约的部分。
