...
长安链采用了普罗米修斯（`Prometheus`）的监控体系，提供了脚本，帮助用户快速搭建基于`Docker`的普罗米修斯可视化监控环境，并基于该环境进行长安链节点的可视化监控。
...
![image-20210407180240152](imgs/image-20210407180240152.png)
...
![image-20210407182850256](imgs/image-20210407182850256.png)
...
![image-20210407183253614](imgs/image-20210407183253614.png)
...
![image-20210407183648490](imgs/image-20210407183648490.png)

## 监控效果展示

> 导入仪表盘后，便可查看到监控效果

![image-20210407184735425](imgs/image-20210407184735425.png)