...
7. 停止节点5，修改节点5的数据库，将B余额改为800个币（修改后的节点5后续的区块将不能达成共识，但不影响其他节点达成共识）
   ...
   ./simple-leveldb ../../build/release/chainmaker-V1.0.0-wx-org5.chainmaker.org/data/ledgerData/chain1 store_state update c5d7d472124c988175beacef2b482206910c94845777eb3689af33e240c67129 800
   ```
...
10. 查看A和B的账户余额和节点5数据库余额值
    ...
    ./simple-leveldb ../../build/release/chainmaker-V1.0.0-wx-org7.chainmaker.org/data/ledgerData/chain1 store_state  query c5d7d472124c988175beacef2b482206910c94845777eb3689af33e240c67129 800
    
    ./cmc client contract system tx --sdk-conf-path=../sdk/testdata/sdk_config.yml --tx-id=4968cacc33a7435bbf4892e1e9447e0588893a4f615142e7824daad827acd327
    ```
...
3. A发起一笔交易，向B转账100个币，查询转账结果应为失败
   ...
   ```sh
   ./cmc client contract user invoke  --contract-name=asset_new7 --method=transfer --sdk-conf-path=../sdk/testdata/sdk_config_bc1_node5.yml --org-id=wx-org1.chainmaker.org --chain-id=chain1 --client-crt-file-paths=../sdk/testdata/crypto-config/wx-org1.chainmaker.org/user/client1/client1.tls.crt --client-key-file-paths=../sdk/testdata/crypto-config/wx-org1.chainmaker.org/user/client1/client1.tls.key --params="{\"amount\":\"100\",\"to\":\"c5d7d472124c988175beacef2b482206910c94845777eb3689af33e240c67129\"}" --sync-result=true
   ```
