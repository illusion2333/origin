...
![](../images/Monitoring-status query.png)
...
![](../images/Monitoring-Login Console.png)
...
![](../images/Monitoring-Adding Data Sources.png)
...
![](../images/Monitoring-Import Dashboard.png)

## 监控效果展示

> 导入仪表盘后，便可查看到监控效果

![](../images/Monitoring-effect display.png)
